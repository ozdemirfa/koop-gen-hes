...
router.post('/', validate({ body: cekSchema }), async (req: AuthRequest<any, any, any, any>, res: Response, next: NextFunction) => {
  try {
...
router.put('/:id', validate({ body: updateCekSchema }), async (req: AuthRequest<any, any, any, any>, res: Response, next: NextFunction) => {
  try {
...
router.patch('/:id/durum', validate({ body: cekDurumSchema }), async (req: AuthRequest<any, any, any, any>, res: Response, next: NextFunction) => {
  try {

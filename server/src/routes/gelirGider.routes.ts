...
router.get('/kategoriler', async (_req: AuthRequest<any, any, any, any>, res: Response, next: NextFunction) => {
  try {
...
router.post('/kategoriler', validate({ body: kategoriSchema }), async (req: AuthRequest<any, any, any, any>, res: Response, next: NextFunction) => {
  try {
...
router.post('/', validate({ body: gelirGiderSchema }), async (req: AuthRequest<any, any, any, any>, res: Response, next: NextFunction) => {
  try {
...
router.put('/:id', validate({ body: updateGelirGiderSchema }), async (req: AuthRequest<any, any, any, any>, res: Response, next: NextFunction) => {
  try {

...
// === SETTINGS ===
// Sprint qa-review-bugfix-faz3 (2026-05-25): Inline guard'sız route'lar kaldırıldı
// (P0 — tüm authenticated kullanıcılar birim/poz oluşturup silebiliyordu). Yerine
// `settings.routes.ts` mount edildi: POST `requireCreateGlobalDefs`, PUT/DELETE
// `requireRole('admin')` ile korunur. GET'ler authMiddleware ile yeterli.

...
router.post('/', validate({ body: createHakedisSchema }), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.put('/:id', validate({ body: updateHakedisSchema }), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.put('/:id/onayla', async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post('/:id/kalemler', validate({ body: hakedisKalemlerBatchSchema }), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {

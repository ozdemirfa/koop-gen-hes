-- Migration: 20260420000008_fix_aidat_view_blok_id.sql
-- Description: Add blok_id to aidat_detaylari view to support direct filtering.
...
SELECT 
    ...
    s.daire_no,
    b.blok_adi,
    s.blok_id, -- Added at the end to avoid column renaming errors

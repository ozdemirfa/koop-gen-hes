-- Migration: 20260424000004_cast_enum_to_text_in_view.sql
-- Description: Cast aidat_durumu enum to TEXT in aidat_detaylari view to prevent type mismatch errors during API filtering.
...
SELECT 
    ...
    a.uye_id,
    a.aidat_tanimi_id,
    a.durum::TEXT as durum, -- Cast to TEXT for easier API filtering
    a.son_odeme_tarihi,
    CASE 
...
BEGIN
    ...
    AND (p_durum IS NULL OR durum = p_durum) -- durum is now TEXT in view
